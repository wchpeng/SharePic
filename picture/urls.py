...
urlpatterns = [
    ...
    path('picture/picture/', views.PictureAddView.as_view(), name='post_picture_info'),
    path('picture/album/', views.AlbumAddInfoView.as_view(), name='post_album_info'),
    path('reply/info/', views.ReplyAddInfoView.as_view(), name='post_reply_info'),
    path('picture/album/<int:album_id>/', views.AlbumInfoView.as_view(), name='album_info'),
